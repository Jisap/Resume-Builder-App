...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  // Descripciones de los templates disponibles
  const templates = [
    {
      id: "classic",
      name: "Classic",
      preview: "A clean, traditional resume format with clear sections and profesional typography"
    },
    {
      id: "modern",
      name: "Modern",
    ...
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
      preview: "Minimal design with a single image and clearn typegraphy"
    },
  ]

  return (
    <div className='relative'>
      {/* Boton para abrir el selector de templates */}
      <button
        ...
        <div className='absolute top-full w-xs p-3 mt-2 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
          {templates.map((template) => (
            <div
              ...
              `}
            >
              {/* Si el id del template seleccionado es igual al id del template del resume, se muestra un check */}
              {selectedTemplate === template.id && (
              ...
              {/* Nombre del template y descripción */}
